...
public class Net {
    ...
    public static final String place = "London";//пробелы придется самому изменить на %20 //percentEscaper//UrlEscaper

    public static Coords getCoords(String place) throws IOException, InterruptedException {
